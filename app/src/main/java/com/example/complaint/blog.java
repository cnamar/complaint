...
public class blog extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (mAuth.getCurrentUser()==null){
                    Intent loginIntent = new Intent(blog.this, RegisterActivity.class);
            ...
            protected void onBindViewHolder(@NonNull BlogzoneViewHolder viewHolder, int position, @NonNull Blog model) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent singleActivity = new Intent(blog.this, SinglePostActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            mAuth.signOut();
            Intent logouIntent = new Intent(blog.this, RegisterActivity.class);
